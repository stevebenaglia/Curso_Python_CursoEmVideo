...
print(f"A metade de {moeda.moeda(input_usuario)} é {moeda.metade(input_usuario, True)}")
print(f"O dobro de {moeda.moeda(input_usuario)} é {moeda.dobro(input_usuario, True)}")
