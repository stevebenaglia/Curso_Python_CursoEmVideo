...
print(f"A metade de {moeda.moeda(input_usuario)} é {moeda.moeda(moeda.metade(input_usuario))}")
print(f"O dobro de {moeda.moeda(input_usuario)} é {moeda.moeda(moeda.dobro(input_usuario))}")
